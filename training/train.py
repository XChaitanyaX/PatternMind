...
CHECKPOINT_PATH = (
    "/content/PatternMind/training/checkpoint.pt"  # where to save progress
)
...
def train():
    ...
    save_path = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "patternmind_final.pt"
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="The training of PatternMind")
    parser.add_argument(
        "--epochs", default=20, type=int, help="No of epochs to train"
    )
    parser.add_argument(
        "--lrate", default=0.0001, type=float, help="The learning rate of the model"
    )
